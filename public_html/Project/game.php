...
//I'm using the game from the html5 canvas homework for now
    ...
    function makeEnemy() {
      ...
      //not a signifigant change i just hated how enemy sizes are random
      var enemySize = 50;
      var enemyY = Math.round(Math.random() * (canvas.height - enemySize * 2)) + enemySize;
      //change 1
      if(score < 10 ){
        var enemySpeed = 1 + score/5 * enemyBaseSpeed;
      }
      else{
        var enemySpeed = 1 + 2 * enemyBaseSpeed;
      }
